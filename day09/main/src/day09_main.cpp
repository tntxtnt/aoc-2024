...
TEST_CASE("day09 - part 1") {
    std::istringstream iss{"2333133121414131402"};
    const Day9Solution::Part1ResultType ans{1928};
    Day9Solution sol;
    const auto res = sol.part1(iss);
    REQUIRE(res == ans);
}

TEST_CASE("day09 - part 2") {
    std::istringstream iss{"2333133121414131402"};
    const Day9Solution::Part2ResultType ans{2858};
    Day9Solution sol;
...
int main(int argc, char** argv) {
    ...
    int returnCode = 0;
    AdventOfCodeSession session(2024, 9);
