...
............
    ...
    const Day8Solution::Part1ResultType ans{14};
    Day8Solution sol;
    const auto res = sol.part1(iss);
    REQUIRE(res == ans);
}

TEST_CASE("day08 - part 2") {
    std::istringstream iss{R"(............
........0...
.....0......
.......0....
...
............
    ...
    const Day8Solution::Part2ResultType ans{34};
    Day8Solution sol;
...
int main(int argc, char** argv) {
    ...
    int returnCode = 0;
    AdventOfCodeSession session(2024, 8);
