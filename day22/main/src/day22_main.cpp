...
TEST_CASE("day22 - part 1") {
    std::istringstream iss{R"(1
10
100
2024
)"};
    const Day22Solution::Part1ResultType ans{37327623};
    Day22Solution sol;
    const auto res = sol.part1(iss);
    REQUIRE(res == ans);
}

TEST_CASE("day22 - part 2") {
    std::istringstream iss{R"(1
2
3
2024
)"};
    const Day22Solution::Part2ResultType ans{23};
    Day22Solution sol;
...
int main(int argc, char** argv) {
    ...
    int returnCode = 0;
    AdventOfCodeSession session(2024, 22);
